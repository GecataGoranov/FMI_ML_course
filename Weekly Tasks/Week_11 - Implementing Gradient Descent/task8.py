...
def draw_dot(root: Value) -> graphviz.Digraph:
    ...
    for n in nodes:
        ...
        if n == root:
            label=f"L | data: {n.data}"
        else:
            label=f"{n.letter} | data: {n.data}"
...
def main() -> None:
    ...
    """
    I just couldn't figure out how to lay the letters and the values horizontally. I tried using 
    a <table>, but it just gave me errors.
    """
