...
def main():
    ...
    clusters_species_df = pd.DataFrame({"labels":pipeline["kmeans"].labels_, "species":species})
    print(pd.crosstab(clusters_species_df["labels"], clusters_species_df["species"]))
