...
def main():
    ...
    labels = hierarchy.fcluster(mergings, 6, criterion="distance")

    labels_varieties_df = pd.DataFrame({"labels":labels, "varieties":varieties})
    print(pd.crosstab(labels_varieties_df["labels"], labels_varieties_df["varieties"]))
