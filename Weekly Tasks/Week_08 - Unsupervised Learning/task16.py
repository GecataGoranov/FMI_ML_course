...
def main():
    ...
    plt.bar(pipeline.get_feature_names_out(), height=pipeline["pca"].explained_variance_)
    ...
    # Judging by the plot we saw, it's best to reduce the dataset into 2 features:

    pca = PCA(n_components=2)
    pca.fit(samples)

    transformed_samples = pca.transform(samples)
    print("Shape of PCA features:", transformed_samples.shape)
